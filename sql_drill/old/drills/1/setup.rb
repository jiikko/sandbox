...
takebe.club.club_reports.create(reported_on: Date.new(2011, 1, 3), score: 90)
...
takebe.club.club_reports.create(reported_on: Date.new(2012, 3, 3), score: 70)
takebe.club.club_reports.create(reported_on: Date.new(2012, 3, 4), score: 20)

yamada.club.club_reports.create(reported_on: Date.new(2012, 3, 4), score: 90)
